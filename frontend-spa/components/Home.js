        ...
        <div class="relative max-w-4xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="relative flex flex-col items-center text-center w-full">
              <div class="w-16 h-16 rounded-full bg-blue-50 flex items-center justify-center mb-3 transition-all duration-200 hover:bg-blue-100 border border-blue-100 text-blue-600 relative z-10">
              ...
              <!-- Absolute dashed line extending to the right -->
              <div class="hidden md:block absolute top-8 left-[calc(50%+2rem)] w-[calc(100%-4rem+2rem)] border-t-2 border-dashed border-gray-200 z-0"></div>
